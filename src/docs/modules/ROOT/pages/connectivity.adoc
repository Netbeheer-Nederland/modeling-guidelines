...
Please note there are some requirements and constraints. You can find them at https://connect.nen.nl/Standard/PopUpHtml?RNR=3659951&search=&Native=1&token=2f83a08b-fd9c-450c-b760-ece017b60721#4.3Requirementsandconstraints[IEC 61970-452 4.3 Requirements and constraints]. Here are a  requirement and constraint concerning terminals:
...
Quoted from: https://connect.nen.nl/Standard/PopUpHtml?RNR=3638054&search=&Native=1&token=c2ad0bfb-4555-4275-96f3-03f2b39c1616#4.8.2NumberofterminalsforConductingEquipmentobjects[IEC 61970-301:2020, 4.8.2 "Number of terminals for ConductingEquipment objects."]
