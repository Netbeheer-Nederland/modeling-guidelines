...
Most of the terms in this document are used within the energy industry, particularly in standards like the xref::background.adoc#_common_information_model[IEC Common Information Model (CIM)] and profiles like the European Style Market Profile (ESMP).
