...
:uri: https://{domain}/modeling-guidelines/busbarconfiguration
:version: v0.9 concept

Author:: mailto:ahagreis@netbeheernederland.nl[Arend Hagreis]
//Editors::

Version:: {version}
Feedback:: https://github.com/Netbeheer-Nederland/doc-modeling-guidelines/issues[Issue on GitHub] (https://github.com/Netbeheer-Nederland/doc-modeling-guidelines[`Netbeheer-Nederland/doc-modeling-guidelines`])
